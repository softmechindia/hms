...
function TodayConf() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-20 pb-6 px-4 md:px-8 flex flex-col items-center">
          ...
          <div className="bg-gray-50 p-4 md:p-5 rounded-md  border border-gray-100 flex flex-col md:flex-row gap-4 mb-8 items-center">
            <div className="w-full flex-1 relative">
              ...
              <input 
                ...
                min="2026-01-01" 
                className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm outline-none focus:ring-1 focus:ring-orange-300" 
              />
            </div>
            <div className="w-full flex-1 relative">
            ...
            <DataTable
              ...
              noDataComponent={
                <div className="py-20 text-center text-gray-300">
                   ...
                   <p className="font-medium">No confirmed appointments found</p>
                </div>
              }
            />
          </div>
