...
function  AddMedicineGenericPopup({ isOpen, onClose, onSave }) {
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 px-4">
      <div className="w-full max-w-md bg-white rounded shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100">
          <h2 className="text-xl font-semibold text-gray-700">Add Medicine Generic Name</h2>
...
export default AddMedicineGenericPopup;