...
function SupplierListPopup({ isOpen, onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 px-4">
      <div className="w-full max-w-2xl bg-white rounded shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">

        {/* Header */}
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100">
          <h2 className="text-xl font-semibold text-gray-700">Add Supplier List</h2>
        ...
        {/* Footer */}
        <div className="px-4 py-4 flex justify-end gap-3 border-t border-gray-50">
          <button
            onClick={handleSub}
...
export default SupplierListPopup;