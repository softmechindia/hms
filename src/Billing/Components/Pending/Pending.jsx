    ...
    { 
      ...
      cell: (row) => (
        <div className="py-2">
          ...
          <div className="text-[12px] font-bold text-gray-8000 flex items-center gap-1"><Clock size={10}/> {row.time}</div>
        </div>
      )
    },
  ...
  const customStyles = {
    ...
    pagination: {
      style: {
        ...
        paddingRight: "50px", // Align under 'Verify By'
        paddingTop: "10px",
        paddingBottom: "10px",
      },
    },
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-4 md:p-8">
        <h1 className="text-xl font-black text-gray-800 mb-6  tracking-tight">Pending Appointments</h1>
